...
def format_for_classifier(data_list, label):
    ...
    return([[{j:True for j in i.split()}, label] for i in data_list])
...
def generate(model, first_word, num_words):
    ...
    for i in range(num_words):
        temp_word = random.choice(model[temp_word])
        s += " " + temp_word
    return(s)
...
tst = "Yeah baby I like it like that You gotta believe me when I tell you I said I like it like that"
